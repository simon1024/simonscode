<div id="main-content" class="clearfix">
    ...
    <div id="page-content" class="clearfix dataTables_wrapper">
        ...
        <div class="row-fluid">
           ...
           <div class="span6 filter_item"  style='width:35%;margin-left:0'>
                <div class="dataTables_length">
                    <label>
                    项目状态: 
           ...
           <div class="span6 filter_item"  style='width:45%'>
                <div class="dataTables_length">
                    <label>
                    时间范围: 
                    ...
                    <span class="btn btn-info btn-small tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="高级查询" id="resetProjectQuery">重置</span>
                </div>
           </div>
        </div> <!-- row-fluid end -->
        <!-- search end -->
