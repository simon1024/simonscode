<div id="main-content" class="clearfix">
    ...
    <div id="page-content" class="clearfix dataTables_wrapper">
        ...
        <div class="row-fluid">
           ...
           <div class="span4 filter_item"  style='width:40%'>
                <div class="dataTables_length">
                    <label>
                    时间范围: 
                    ...
                    <span class="btn btn-info btn-small tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="高级查询" id="advanceProjectQuery_View">查询</span>
                    ...
                    <tbody>
                        ...
                        <tr class="selected">
                            ...
                            <td style="text-align:center;width:60px;">
                                ...
                                <a href="#" class="tooltip-info" data-rel="tooltip" title="" data-placement="left" data-original-title="浏览详情"  onclick="toViewProject({id})" style="text-decoration:none">
                                    <span class="blue"><i class="icon-eye-open bigger-120"></i></span>
                                </a>&nbsp;&nbsp;
...
$(function() {
        var noTags = [
        {pjList}
                {label:"{no} {name}", value:'{no}'},
        {/pjList}
        ];

        $( "#search_no" ).autocomplete({
            source: noTags,
            minChars:0
        });
